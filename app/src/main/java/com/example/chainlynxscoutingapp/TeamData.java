...
public class TeamData {
    ...
    public int autoConesScoredHigh;
    public int autoConesScoredMid;
    public int autoConesScoredHybrid;
    public int autoCubesScoredHigh;
    ...
    public int teleopCubesScoredHigh;
